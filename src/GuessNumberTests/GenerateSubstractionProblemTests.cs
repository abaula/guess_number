...
{
    public class GenerateSubstractionProblemTests
    {
        ...
        public void Execute_CaseA_CallsCreateGameTaskWithCorrectParameters()
        {
            ...
            var sut = new GenerateSubstractionProblem(LazyHelper.ToLazy(mockGetRandomInt.Object), LazyHelper.ToLazy(mockCreateGameTask.Object));
            ...
            mockCreateGameTask.Verify(x => x.Execute(8, default, 5, 3, Operation), Times.Once());
        }
        ...
        public void Execute_CaseB_CallsCreateGameTaskWithCorrectParameters()
        {
            ...
            // Assert
            mockGetRandomInt.Verify(x => x.Execute(It.IsAny<int>(), It.IsAny<int>()), Times.Exactly(3));
            mockCreateGameTask.Verify(x => x.Execute(8, 3, default, 5, Operation), Times.Once());
        }
